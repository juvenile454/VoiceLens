...
| `test_ui.py` | GTK-Buttons/Signale, Start ohne Icon/CSS, Einrichtungshinweise bei mehreren Fehlern | xvfb, kein Mikrofon |
...
Rendert GTK-Ansichten in beiden Sprachen sowie eine Szene mit dem Original-Overlay-Renderer und synthetischen Pegeln. Startet keine Aufnahme und installiert keine Erweiterung. Das ersetzt keinen Live-Test des GNOME-Overlays in einer fremden Anwendung.
